...
const buttonClass = 'inline-flex h-12 items-center justify-center rounded-2xl bg-[var(--slot4-dark-bg)] px-6 text-sm font-black uppercase tracking-[0.22em] text-[var(--slot4-dark-text)] transition hover:-translate-y-0.5 disabled:opacity-60'
